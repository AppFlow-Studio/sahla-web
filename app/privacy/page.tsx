      ...
      <section className="bg-[#fffbf2] py-[60px]">
        <div className="mx-auto max-w-[720px] px-8">
          <div className="prose-green space-y-8 text-[15px] leading-[1.8] text-dark-green/65">
            <div>
              <h2 className="mb-3 font-[family-name:var(--font-hero)] text-[22px] text-dark-green">1. Information We Collect</h2>
            ...
            <div>
              <h2 className="mb-3 font-[family-name:var(--font-hero)] text-[22px] text-dark-green">2. How We Use Your Information</h2>
            ...
            <div>
              <h2 className="mb-3 font-[family-name:var(--font-hero)] text-[22px] text-dark-green">3. Congregant Data</h2>
            ...
            <div>
              <h2 className="mb-3 font-[family-name:var(--font-hero)] text-[22px] text-dark-green">4. Donation Data</h2>
            ...
            <div>
              <h2 className="mb-3 font-[family-name:var(--font-hero)] text-[22px] text-dark-green">5. Data Security</h2>
            ...
            <div>
              <h2 className="mb-3 font-[family-name:var(--font-hero)] text-[22px] text-dark-green">6. Data Retention & Deletion</h2>
            ...
            <div>
              <h2 className="mb-3 font-[family-name:var(--font-hero)] text-[22px] text-dark-green">8. Changes to This Policy</h2>
