...
function MetricCard({
  ...
  return (
    <motion.div
      ...
      className={card + " px-5 py-5 transition-colors hover:border-edge-bold"}
    >
...
export default function OverviewClient({
  ...
  const [activityAnimateRef] = useAutoAnimate({ duration: 200 });
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-3">
        <span className="text-[10px] font-semibold uppercase tracking-widest text-faint">Quick links</span>
        ...
        <div className="flex items-center gap-1.5">
          {([
            ...
            <a
              ...
              className="rounded-lg px-3 py-1.5 text-[11px] font-medium text-subtle transition-colors hover:bg-white hover:text-ink hover:shadow-sm"
            >
              {link.label}
            </a>
          ))}
      ...
      <FadeInSection className="grid gap-5 lg:grid-cols-5">
              ...
              {PIPELINE_STAGES.map((stage) => {
                ...
                return (
                  <div key={stage.key} className="flex items-center gap-3">
                    ...
                    <div className="relative h-7 flex-1 overflow-hidden rounded-lg bg-ink/[0.03]">
                      <motion.div
          ...
          <div className={card + " p-5"}>
            ...
            <div className="grid grid-cols-4 gap-3">
              {([
                ...
                <div key={s.label} className="rounded-xl bg-ink/[0.02] px-3 py-3 text-center">
        ...
        <div className={card + " flex flex-col overflow-hidden lg:col-span-2"}>
          ...
          <div ref={activityAnimateRef} className="flex-1 overflow-y-auto" style={{ maxHeight: 320 }}>
          ...
          <div className="flex-1 p-5">
            <div className="grid grid-cols-3 gap-3">
              {([
                ...
                <div key={s.label} className="rounded-xl bg-ink/[0.02] px-3 py-2.5 text-center">
