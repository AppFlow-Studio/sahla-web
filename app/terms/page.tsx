    ...
    <div className="relative">
      ...
      <section className="bg-[#fffbf2] pt-36 pb-10">
        <div className="mx-auto max-w-[800px] px-8 text-center">
          ...
          <p className="mt-4 text-[14px] text-dark-green/40">Last updated: April 23, 2026</p>
        </div>
      </section>
      ...
      <section className="bg-[#fffbf2] py-[60px]">
        <div className="mx-auto max-w-[720px] px-8">
          <div className="prose-green space-y-8 text-[15px] leading-[1.8] text-dark-green/65">
            <div>
              <h2 className="mb-3 font-[family-name:var(--font-hero)] text-[22px] text-dark-green">1. Agreement to Terms</h2>
            ...
            <div>
              <h2 className="mb-3 font-[family-name:var(--font-hero)] text-[22px] text-dark-green">2. Description of Service</h2>
            ...
            <div>
              <h2 className="mb-3 font-[family-name:var(--font-hero)] text-[22px] text-dark-green">3. Subscription & Payment</h2>
            ...
            <div>
              <h2 className="mb-3 font-[family-name:var(--font-hero)] text-[22px] text-dark-green">4. App Ownership</h2>
            ...
            <div>
              <h2 className="mb-3 font-[family-name:var(--font-hero)] text-[22px] text-dark-green">5. Data Ownership & Privacy</h2>
            ...
            <div>
              <h2 className="mb-3 font-[family-name:var(--font-hero)] text-[22px] text-dark-green">6. Content Responsibility</h2>
            ...
            <div>
              <h2 className="mb-3 font-[family-name:var(--font-hero)] text-[22px] text-dark-green">7. Cancellation & Data Export</h2>
            ...
            <div>
              <h2 className="mb-3 font-[family-name:var(--font-hero)] text-[22px] text-dark-green">8. Service Availability</h2>
            ...
            <div>
              <h2 className="mb-3 font-[family-name:var(--font-hero)] text-[22px] text-dark-green">9. Limitation of Liability</h2>
            ...
            <div>
              <h2 className="mb-3 font-[family-name:var(--font-hero)] text-[22px] text-dark-green">10. Changes to Terms</h2>
            ...
            <div>
              <h2 className="mb-3 font-[family-name:var(--font-hero)] text-[22px] text-dark-green">11. Contact</h2>
